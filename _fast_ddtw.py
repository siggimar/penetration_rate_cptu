...
# script imported in simple DTW example in "dtw_ex.py"
# otherwise not used in study
#
## code adapted from: https://github.com/slaypni/fastdtw
## Original work is copyrighted (c) 2015 Kazuaki Tanida, and distributed under the MIT licence.
##
## For details on method see: Stan Salvador and Philip Chan. 2007. Toward accurate dynamic time warping in linear time and space. Intell. Data Anal. 11, 5 (October 2007), 561–580.
